        ...
        <div className='settings-content'>
          ...
          {activeTab === 'security' && (
            <div className='settings-section'>
              ...
              <div className='settings-grid'>
                <div className='setting-card'><div className='setting-label'>Session Timeout (minutes)</div><p className='setting-desc'>Automatically log out inactive admin sessions</p><input type='number' className='setting-input' min={5} max={480} value={form.security.sessionTimeout} onChange={e => update('security', 'sessionTimeout', Number(e.target.value))} /><div className='setting-hint'>30 minutes recommended for shared devices</div></div>
                <div className='setting-card'><div className='setting-label'>Max Login Attempts</div><p className='setting-desc'>Lock account after consecutive failed attempts</p><input type='number' className='setting-input' min={1} max={20} value={form.security.maxLoginAttempts} onChange={e => update('security', 'maxLoginAttempts', Number(e.target.value))} /><div className='setting-hint'>5 attempts balances security and usability</div></div>
                <div className='setting-card'><div className='setting-label'>Minimum Password Length</div><p className='setting-desc'>Enforced for all user accounts</p><input type='number' className='setting-input' min={6} max={64} value={form.security.passwordMinLength} onChange={e => update('security', 'passwordMinLength', Number(e.target.value))} /><div className='setting-hint'>NIST recommends at least 8 characters</div></div>
          ...
          {activeTab === 'voting' && (
            <div className='settings-section'>
              ...
              <div className='settings-grid'>
                <div className='setting-card'><div className='setting-label'>Registration Opens</div><p className='setting-desc'>When students can begin registering</p><input type='datetime-local' className='setting-input' value={form.voting.registrationStart.slice(0, 16)} onChange={e => update('voting', 'registrationStart', e.target.value + ':00')} /></div>
                <div className='setting-card'><div className='setting-label'>Registration Closes</div><p className='setting-desc'>Deadline for voter registration</p><input type='datetime-local' className='setting-input' value={form.voting.registrationEnd.slice(0, 16)} onChange={e => update('voting', 'registrationEnd', e.target.value + ':00')} /></div>
                <div className='setting-card'><div className='setting-label'>Voting Opens</div><p className='setting-desc'>When the ballot becomes available</p><input type='datetime-local' className='setting-input' value={form.voting.votingStart.slice(0, 16)} onChange={e => update('voting', 'votingStart', e.target.value + ':00')} /></div>
                <div className='setting-card'><div className='setting-label'>Voting Closes</div><p className='setting-desc'>Ballots are no longer accepted after this time</p><input type='datetime-local' className='setting-input' value={form.voting.votingEnd.slice(0, 16)} onChange={e => update('voting', 'votingEnd', e.target.value + ':00')} /></div>
                <div className='setting-card setting-card-full'><div className='setting-label'>Maximum Votes Per Voter</div><p className='setting-desc'>Number of positions a voter can cast in one session</p><input type='number' className='setting-input' min={1} max={20} value={form.voting.maxVotesPerVoter} onChange={e => update('voting', 'maxVotesPerVoter', Number(e.target.value))} /></div>
                <div className='setting-card setting-card-full'><div className='setting-label'>Allow Vote Change</div><p className='setting-desc'>Voters may modify their ballot before the voting window closes</p><div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '8px 0' }}><T toggle={form.voting.allowVoteChange} setToggle={v => update('voting', 'allowVoteChange', v)} /><span className={form.voting.allowVoteChange ? 'toggle-label-on' : 'toggle-label-off'}>{form.voting.allowVoteChange ? 'Enabled — voters may update selections' : 'Disabled — ballot is final on submission'}</span></div></div>
                <div className='setting-card setting-card-full'><div className='setting-label'>Vote Confirmation Required</div><p className='setting-desc'>Show a review screen before finalizing the ballot</p><div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '8px 0' }}><T toggle={form.voting.voteConfirmationRequired} setToggle={v => update('voting', 'voteConfirmationRequired', v)} /><span className={form.voting.voteConfirmationRequired ? 'toggle-label-on' : 'toggle-label-off'}>{form.voting.voteConfirmationRequired ? 'Enabled' : 'Disabled'}</span></div></div>
                <div className='setting-card setting-card-full'><div className='setting-label'>Show Results After Close</div><p className='setting-desc'>Automatically reveal results when voting ends</p><div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '8px 0' }}><T toggle={form.voting.showResultsAfterClose} setToggle={v => update('voting', 'showResultsAfterClose', v)} /><span className={form.voting.showResultsAfterClose ? 'toggle-label-on' : 'toggle-label-off'}>{form.voting.showResultsAfterClose ? 'Enabled' : 'Disabled'}</span></div></div>
              </div>
          ...
          {activeTab === 'branding' && (
            <div className='settings-section'>
              ...
              <div className='settings-grid'>
                <div className='setting-card'><div className='setting-label'>Site Name</div><p className='setting-desc'>Displayed in headers and emails</p><input type='text' className='setting-input' value={form.branding.siteName} onChange={e => update('branding', 'siteName', e.target.value)} /></div>
                <div className='setting-card'><div className='setting-label'>Header Text</div><p className='setting-desc'>Tagline shown on the voting portal</p><input type='text' className='setting-input' value={form.branding.headerText} onChange={e => update('branding', 'headerText', e.target.value)} /></div>
                <div className='setting-card'><div className='setting-label'>Footer Text</div><p className='setting-desc'>Displayed at the bottom of all pages</p><input type='text' className='setting-input' value={form.branding.footerText} onChange={e => update('branding', 'footerText', e.target.value)} /></div>
                <div className='setting-card'><div className='setting-label'>Primary Color</div><p className='setting-desc'>Main accent color used across the interface</p><div className='color-picker-row'><input type='color' className='color-picker' value={form.branding.primaryColor} onChange={e => update('branding', 'primaryColor', e.target.value)} /><input type='text' className='setting-input color-hex-input' value={form.branding.primaryColor} onChange={e => update('branding', 'primaryColor', e.target.value)} pattern='^#[0-9a-fA-F]{6}$' /></div></div>
                <div className='setting-card'><div className='setting-label'>Secondary Color</div><p className='setting-desc'>Supporting accent and text colors</p><div className='color-picker-row'><input type='color' className='color-picker' value={form.branding.secondaryColor} onChange={e => update('branding', 'secondaryColor', e.target.value)} /><input type='text' className='setting-input color-hex-input' value={form.branding.secondaryColor} onChange={e => update('branding', 'secondaryColor', e.target.value)} pattern='^#[0-9a-fA-F]{6}$' /></div></div>
                <div className='setting-card'><div className='setting-label'>Logo URL</div><p className='setting-desc'>Public URL to the organization logo (PNG or SVG)</p><input type='url' className='setting-input' value={form.branding.logoUrl} onChange={e => update('branding', 'logoUrl', e.target.value)} placeholder='https://example.edu/logo.png' /></div>
                <div className='setting-card'><div className='setting-label'>Favicon URL</div><p className='setting-desc'>Small icon shown in browser tabs</p><input type='url' className='setting-input' value={form.branding.faviconUrl} onChange={e => update('branding', 'faviconUrl', e.target.value)} placeholder='https://example.edu/favicon.ico' /></div>
              </div>
          ...
          {activeTab === 'backup' && (
            <div className='settings-section'>
              ...
              <div className='settings-grid'>
                <div className='setting-card'><div className='setting-label'>Auto Backup</div><p className='setting-desc'>Automatically create backups on schedule</p><div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '8px 0' }}><T toggle={form.backup.autoBackup} setToggle={v => update('backup', 'autoBackup', v)} /><span className={form.backup.autoBackup ? 'toggle-label-on' : 'toggle-label-off'}>{form.backup.autoBackup ? 'Enabled' : 'Disabled'}</span></div></div>
                <div className='setting-card'><div className='setting-label'>Backup Frequency</div><p className='setting-desc'>How often to create backups</p><select className='setting-select' value={form.backup.backupFrequency} onChange={e => update('backup', 'backupFrequency', e.target.value)}><option value='hourly'>Hourly</option><option value='daily'>Daily</option><option value='weekly'>Weekly</option></select></div>
                <div className='setting-card'><div className='setting-label'>Retention Period (days)</div><p className='setting-desc'>How many days of backups to keep</p><input type='number' className='setting-input' min={1} max={365} value={form.backup.backupRetention} onChange={e => update('backup', 'backupRetention', Number(e.target.value))} /></div>
                <div className='setting-card'><div className='setting-label'>Remote Storage</div><p className='setting-desc'>Upload encrypted backups to off-site storage</p><div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '8px 0' }}><T toggle={form.backup.remoteStorage} setToggle={v => update('backup', 'remoteStorage', v)} /><span className={form.backup.remoteStorage ? 'toggle-label-on' : 'toggle-label-off'}>{form.backup.remoteStorage ? 'Enabled' : 'Disabled'}</span></div></div>
                <div className='setting-card'><div className='setting-label'>Backup Encryption</div><p className='setting-desc'>Encrypt all backups with AES-256</p><div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '8px 0' }}><T toggle={form.backup.backupEncryption} setToggle={v => update('backup', 'backupEncryption', v)} /><span className={form.backup.backupEncryption ? 'toggle-label-on' : 'toggle-label-off'}>{form.backup.backupEncryption ? 'Enabled' : 'Disabled'}</span></div></div>
              </div>
